---
comments: true
description: Learn how to use Multi-Object Tracking with YOLO. Explore datasets formats and see upcoming features for training trackers. Start with Python or CLI examples.
