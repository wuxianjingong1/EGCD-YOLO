---
comments: true
description: Explore the supported datasets formats for Ultralytics YOLO and learn how to prepare and use datasets for training object segmentation models.
keywords: Ultralytics, YOLO, instance segmentation, datasets formats, auto-annotation, COCO, segmentation models, training data
---
...
path: ../datasets/coco8-seg # datasets root dir
