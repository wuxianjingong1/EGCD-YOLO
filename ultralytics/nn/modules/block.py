...
from ultralytics.nn.modules.odconv import ODConv_3rd
__all__ = (
    "MV2Block",
    "DFL",
    "HGBlock",
...
class Bottleneck_DySnakeConv(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3),
                 e=0.5):  # ch_in, ch_out, shortcut-残差连接, groups, kernels, expand
        super().__init__()
        c_ = int(c2 * e)  # hidden channels
        if k[0] == 3:
...
class C2f_DySnakeConv(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):  # ch_in, ch_out, number, shortcut, groups, expansion
        ...
        self.cv2 = Conv((2 + n) * self.c, c2, 1)  # optional act=FReLU(c2)
        self.m = nn.ModuleList(
            Bottleneck_DySnakeConv(self.c, self.c, shortcut, g, k=(3, 3), e=1.0) for _ in range(n))  # Bottleneck
...
class RFAConv(nn.Module):
    def __init__(self, in_channel, out_channel, kernel_size=3, stride=1):
        ...
        self.conv = Conv_rfa(in_channel, out_channel, k=kernel_size, s=kernel_size, p=0)
