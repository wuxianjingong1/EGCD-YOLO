...
class Model(nn.Module):
    ...
    Methods:
        ...
        val: Validates the model on a datasets.
        benchmark: Benchmarks the model on various export formats.
        export: Exports the model to different formats.
        train: Trains the model on a datasets.
    ...
    def val(
        ...
        **kwargs,
        ...
        """
        Validates the model using a specified datasets and validation configuration.
    ...
    def train(
        ...
        **kwargs,
        ...
        """
        Trains the model using the specified datasets and training configuration.
