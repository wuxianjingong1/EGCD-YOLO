...
def check_det_dataset(dataset, autodownload=True):
    ...
    Args:
        ...
        autodownload (bool, optional): Whether to automatically download the datasets if not found. Defaults to True.

    Returns:
        (dict): Parsed datasets information and paths.
    """
...
def check_cls_dataset(dataset, split=""):
    """
    Checks a classification datasets such as Imagenet.

    This function accepts a `datasets` name and attempts to retrieve the corresponding datasets information.
    If the datasets is not found locally, it attempts to download the datasets from the internet and save it locally.

    Args:
        dataset (str | Path): The name of the datasets.
        split (str, optional): The split of the datasets. Either 'val', 'test', or ''. Defaults to ''.
    ...
    Returns:
        (dict): A dictionary containing the following keys:
            ...
            - 'names' (dict): A dictionary of class names in the datasets.
    """
...
class HUBDatasetStats:
    ...
    Args:
        ...
        autodownload (bool): Attempt to download datasets if not found locally. Default is False.
...
def autosplit(path=DATASETS_DIR / "coco8/images", weights=(0.9, 0.1, 0.0), annotated_only=False):
    """
    Automatically split a datasets into train/val/test splits and save the resulting splits into autosplit_*.txt files.
