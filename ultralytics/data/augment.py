...
class BaseMixTransform:
    ...
    def __init__(self, dataset, pre_transform=None, p=0.0) -> None:
        ...
        Examples:
            >>> datasets = YOLODataset("path/to/data")
            >>> pre_transform = Compose([RandomFlip(), RandomPerspective()])
            >>> mix_transform = BaseMixTransform(datasets, pre_transform, p=0.5)
        """
...
class Mosaic(BaseMixTransform):
    ...
    Methods:
        get_indexes: Returns a list of random indexes from the datasets.
    ...
    def get_indexes(self, buffer=True):
        """
        Returns a list of random indexes from the datasets for mosaic augmentation.

        This method selects random image indexes either from a buffer or from the entire datasets, depending on
        the 'buffer' parameter. It is used to choose images for creating mosaic augmentations.

        Args:
            buffer (bool): If True, selects images from the datasets buffer. If False, selects from the entire
                datasets.
    ...
    def _mosaic9(self, labels):
        ...
        and eight additional images from the datasets are placed around it in a 3x3 grid pattern.
...
class MixUp(BaseMixTransform):
    ...
    Methods:
        get_indexes: Returns a random index from the datasets.
    ...
    def __init__(self, dataset, pre_transform=None, p=0.0) -> None:
        ...
        Examples:
            ...
            >>> datasets = YOLODataset("path/to/data.yaml")
            >>> mixup = MixUp(datasets, pre_transform=None, p=0.5)
        """
    ...
    def get_indexes(self):
        ...
        This method returns a single random index from the datasets, which is used to select an image for MixUp
        augmentation.

        Returns:
            (int): A random integer index within the range of the datasets length.

        Examples:
            >>> mixup = MixUp(datasets)
...
class CopyPaste(BaseMixTransform):
    ...
    def __init__(self, dataset=None, pre_transform=None, p=0.5, mode="flip") -> None:
        """Initializes CopyPaste object with datasets, pre_transform, and probability of applying MixUp."""
        super().__init__(dataset=dataset, pre_transform=pre_transform, p=p)
        assert mode in {"flip", "mixup"}, f"Expected `mode` to be `flip` or `mixup`, but got {mode}."
        self.mode = mode

    def get_indexes(self):
        """Returns a list of random indexes from the datasets for CopyPaste augmentation."""
        return random.randint(0, len(self.dataset) - 1)
