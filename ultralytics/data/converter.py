...
def convert_coco(
    ...
    """
    Converts COCO datasets annotations to a YOLO annotation format  suitable for training YOLO models.
...
def convert_segment_masks_to_yolo_seg(masks_dir, output_dir, classes):
    """
    Converts a datasets of segmentation mask images to the YOLO segmentation format.
    ...
    Args:
        ...
        classes (int): Total classes in the datasets i.e. for COCO classes=80
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    """
    Converts DOTA datasets annotations to YOLO OBB (Oriented Bounding Box) format.
...
def yolo_bbox2segment(im_dir, save_dir=None, sam_model="sam_b.pt"):
    """
    Converts existing object detection datasets (bounding boxes) to segmentation datasets or oriented bounding box (OBB)
...
def create_synthetic_coco_dataset():
    """
    Creates a synthetic COCO datasets with random images based on filenames from label lists.

    This function downloads COCO labels, reads image filenames from label list files,
    creates synthetic images for train2017 and val2017 subsets, and organizes
    them in the COCO datasets structure. It uses multithreading to generate images efficiently.
    ...
    def create_synthetic_image(image_file):
        """Generates synthetic images with random sizes and colors for datasets augmentation or testing purposes."""
    ...
    print("Synthetic COCO datasets created successfully.")
